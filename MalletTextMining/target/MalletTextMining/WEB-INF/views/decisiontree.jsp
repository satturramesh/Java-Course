...
#Nav {
 ...
 <nav id="Nav">
    <div class="nav-wrapper">
      <a href="#" class="brand-logo">DECISION TREE ALGORITHM</a>
      <ul id="nav-mo bile" class="right hide-on-med-and-down">
...
Training Precision			:${	precisiontrain} <br><br>
Testing Precision			:${	precisiontest} <br><br>
